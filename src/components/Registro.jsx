    ...
    <>
      ...
      {/* Registro recibe a los restantes elementos creados (punto 1) */}
        ...
        {/* se pasan los íconos a través de props (punto 2) */}
          <SocialButton logo={<i class='fa-brands fa-facebook fa-3x'></i>} />
          <SocialButton logo={<i class='fa-brands fa-github fa-3x'></i>} />
          <SocialButton logo={<i class='fa-brands fa-linkedin-in fa-3x'></i>} />
        </div>
